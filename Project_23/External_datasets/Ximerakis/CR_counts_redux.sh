...
for FASTQ in $(cat copyfilesXimerakis.txt) ; do
	cellranger count --id=Redux${FASTQ} --fastqs=./${FASTQ} --transcriptome=/exports/eddie/scratch/s2268606/Project_23/Ensembl_refs/Cellranger_Mouse_genome_redux/
done
