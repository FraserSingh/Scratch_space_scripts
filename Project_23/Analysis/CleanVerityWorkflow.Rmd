...
# Upregulated genes
Verity_astrocyte_prion_markers_up<-subset(Verity_astrocyte_prion_markers, subset=avg_log2FC>0.25)

#Create a list of just the genes: 
Verity_Prion_DEGs_up = rownames(Verity_astrocyte_prion_markers_up$gene)
#Convert this gene SYMBOL list into Entrez ID:
Verity_DEGs_PrionUp__entrez = bitr(Verity_Prion_DEGs_up, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db)
...
ggp2 = dotplot(VerityPrion_up_GO_OvR, showCategory=10)
ggp3 = goplot(VerityPrion_up_GO_OvR, showCategory = 10)
...
#GO GSEA
ego3 <- gseGO(geneList     = Verity_DEGs_PrionUp__entrez$ENTREZID,
              OrgDb        = org.Mm.eg.db,
              ont          = "ALL",
              minGSSize    = 100,
              maxGSSize    = 500,
