...
Verity_Prion_comp_astrocytes<-subset(Verity_Prion_comp, idents=c('3','20','24'))
```
...
#Show the clustering of subset astrocytes
DimPlot(Verity_Ageing_comp_astrocytes, group.by = 'RNA_snn_res.0.2', reduction = 'umap', repel = TRUE, raster=F, seed.use=42)
