...
writing_dir<-"/home/s2268606/University_Directories/Project_23/Analysis/Writing_dir"
system(paste0("mkdir ", writing_dir))
rm(writing_dir)
...
Verity_comparisons_filtered_QC<-Verity_comparisons_filtered_QC+
  Verity_comparisons_filtered_barplot+
...
Verity_comparisons_filtered_QC

ggsave("Verity_comparisons_filtered_QC.png",plot=Verity_comparisons_filtered_QC,device='png', path=plotting_path_Ver,width = 30, height = 15, units = 'cm' )
...
Verity_astrocyte_markers_plot<- plot_without_legend + plot_layout(guides = "collect",ncol=3) 

ggsave("Verity_astrocyte_markers_plot.png",plot=Verity_astrocyte_markers_plot,device='png', path=plotting_path_Ver,width = 30, height = 20, units = 'cm' )
...
Verity_astrocyte_treatment_plot<-DimPlot(Verity_Prion_comp_astrocytes, reduction = 'umap',  raster=F, group.by='treatment')+ggtitle("Verity data astrocytes", subtitle="Labelled by treatment")
Verity_astrocyte_treatment_plot
ggsave("Verity_astrocyte_treatment_plot.png",plot=Verity_astrocyte_treatment_plot,device='png', path=plotting_path_Ver,width = 20, height = 15, units = 'cm' )
...
# Combine the plot and legend using patchwork
Verity_reactive_astrocyte_plot<- plot_without_legend + plot_layout(guides = "collect",ncol=3) 

Verity_reactive_astrocyte_plot
ggsave("Verity_reactive_astrocyte_plot.png",plot=Verity_reactive_astrocyte_plot,device='png', path=plotting_path_Ver,width = 20, height = 20, units = 'cm' )
...
save(Verity_astrocyte_prion_markers_entrez, file=paste0(writing_dir,"/Verity_astrocyte_prion_markers_entrez.RData"))
...
save(VerityPrion_up_GO_ORA, file=paste0(writing_dir,"/VerityPrion_up_GO_ORA.RData"))

#WIP could reduce terms by using simplify
...
ggp2 <- dotplot(VerityPrion_up_GO_ORA, showCategory=10)
...
save(VerityPrion_down_GO_ORA, file=paste0(writing_dir,"/VerityPrion_down_GO_ORA.RData"))
...
png(paste0(plotting_path,"Verity_Prion_GOR_down_barplot.png"), width = 1000,height = 750)
ggp_b
dev.off()
png(paste0(plotting_path,"Verity_Prion_GOR_down_dotplot.png"), width = 1000,height = 750)
ggp2_b
dev.off()
png(paste0(plotting_path,"Verity_Prion_GOR_down_goplot.png"), width = 1000,height = 750)
ggp3_b
dev.off()
png(paste0(plotting_path,"Verity_Prion_GOR_down_cnetplot.png"), width = 1500,height = 1000)
ggp4_b
dev.off()
png(paste0(plotting_path,"Verity_Prion_GOR_down_heatplot.png"), width = 1500,height = 1000)
ggp5_b
dev.off()
...
save(VP_GO_GSEA, file=paste0(writing_dir,"/VP_GO_GSEA.RData"))
...
png(paste0(plotting_path,"Verity_Ageing_GOR_down_barplot.png"), width = 1000,height = 750)
ggp_b
dev.off()
png(paste0(plotting_path,"Verity_Ageing_GOR_down_dotplot.png"), width = 1000,height = 750)
ggp2_b
dev.off()
png(paste0(plotting_path,"Verity_Ageing_GOR_down_goplot.png"), width = 1000,height = 750)
ggp3_b
dev.off()
png(paste0(plotting_path,"Verity_Ageing_GOR_down_cnetplot.png"), width = 1500,height = 1000)
ggp4_b
dev.off()
png(paste0(plotting_path,"Verity_Ageing_GOR_down_heatplot.png"), width = 1500,height = 1000)
ggp5_b
dev.off()
