...
Verity_reactive_astrocyte_plot<-FeaturePlot(Verity_Prion_comp_astrocytes,features=c('Gfap','Cd44'), raster=F)&plot_annotation(title="Verity data astrocytes", subtitle="highlighting reactive astrocyte genes")
Verity_reactive_astrocyte_plot
ggsave("Verity_reactive_astrocyte_plot.png",plot=Verity_reactive_astrocyte_plot,device='png', path=plotting_path_Ver,width = 30, height = 10, units = 'cm' )
...
ggp2_b<-dotplot(VerityPrion_down_GO_ORA, showCategory=20)
