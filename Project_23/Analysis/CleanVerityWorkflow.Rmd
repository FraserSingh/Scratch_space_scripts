...
```
Plotting by treatment shows that integration is not required.
...
#FIXME
# VlnPlot(Ver_singlets_merged_clean, features = "Gfap")
```
The astrocyte markers show that clusters 3 and 26 expressed the astrocyte markers the strongest in our clusters or most definitively anyway)
...
Verity_astrocyte_prion_markers_clean<-Verity_astrocyte_prion_markers_clean[order(-Verity_astrocyte_prion.markers_defaults$avg_log2FC), ]
#Save the file
