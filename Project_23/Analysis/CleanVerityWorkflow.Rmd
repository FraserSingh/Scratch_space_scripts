...
Verity_Prion_comp_astrocytes<-subset(Verity_Prion_comp, idents=c('3','21','18'))
```
...
Verity_DEGs_AgeingUp__entrez = bitr(Verity_Prion_DEGs_up, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db)
#Remove NAs
...
ggp = barplot(VerityAgeing_up_GO_OvR , showCategory=20)
ggp2 = dotplot(VerityAgeing_up_GO_OvR, showCategory=10)
ggp3 = goplot(VerityAgeing_up_GO_OvR, showCategory = 10)
ggp4 = cnetplot(VerityAgeing_up_GO_OvR, categorySize=p.adjust)
ggp5<- cnetplot(VerityAgeing_up_GO_OvR, categorySize="pvalue", foldChange=geneList)
ggp6<-heatplot(VerityAgeing_up_GO_OvR, foldChange=geneList, showCategory=20)
...
#Subset out astrocytes
Verity_Ageing_comp_astrocytes<-subset(Verity_Ageing_comp, idents=c('4','19'))
```
...
ggp8 = dotplot(VerityAgeing_up_GO_OvR, showCategory=10)
ggp9 = goplot(VerityAgeing_up_GO_OvR, showCategory = 10)
...
ggp12<-heatplot(VerityAgeing_up_GO_OvR, foldChange=geneList, showCategory=20)
