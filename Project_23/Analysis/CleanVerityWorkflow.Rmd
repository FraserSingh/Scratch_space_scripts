...
geneList_entrezname<-Verity_astrocyte_prion_markers$avg_log2FC
geneList_entrezname_df<-as.data.frame(geneList_entrezname)
geneList_entrezname_df$entrezid<-as.character(
(bitr(Verity_astrocyte_prion_markers$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db, drop = F))$ENTREZID
)
