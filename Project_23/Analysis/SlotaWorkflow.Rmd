...
DimPlot(Slota_singlets_merged, label = TRUE, raster=FALSE) + NoLegend()+ ggtitle("Verity clustering", subtitle = "NormalizeData, clustering resolution= 1, UMAPdims20")


DimPlot(Slota_singlets_merged, label = TRUE, raster=FALSE, group.by = "sample", repel = TRUE)+ ggtitle("Verity clustering", subtitle = "NormalizeData, clustering resolution= 1, UMAPdims20")

save(Slota_singlets_merged, file="Rdata/Verity_clustering.RData")
```