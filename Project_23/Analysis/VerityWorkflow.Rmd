...
DimPlot(Verity.combinedNBHME7, reduction = 'umap', label = TRUE, repel = TRUE, raster=F)
...
astrocyte.markers <- FindMarkers(Verity.combinedNBHME7, ident.1 = 1, ident.2 = NULL, min.pct = 0.25, verbose = TRUE, test.use = "DESeq2")
