...
for (folder_name in folder_names) {
  ...
  current_matrix<-Matrix::readMM(folder_path,"/DGE.mtx")
  ...
  current_metadata<-read.csv(folder_path,"/cell_metadata.csv")
  
  current_genes<-read.csv(folder_path, "/all_genes.csv")
  ...
  assign((paste0(folder_name, "_obj")),current_Seurat)

}

#merge the samples into one object 
Verity_total <- merge(sample1, y=c(sample1_obj, sample11_obj, sample2_obj, sample5_obj, sample6_obj, sample9_obj), add.cell.ids=c("sample1", "sample11", "sample2", "sample5", "sample6", "sample9"), project="Verity")

#cleaning up memory
rm("sample1_obj", "sample11_obj", "sample2_obj", "sample5_obj", "sample6_obj", "sample9_obj")
```
