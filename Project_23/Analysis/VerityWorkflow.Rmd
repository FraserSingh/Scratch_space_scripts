...
Verity.combinedNBHME7 <- FindClusters(Verity.combinedNBHME7, resolution = 1)
...
FeaturePlot(Verity.combinedNBHME7,features=c("Aldh1l1","Gfap","Slc1a2"), raster=F)+ggtitle("Integrated Verity data, labelled with astrocyte gene markers", subtitle="RPCA,Clustering resolution 1, 20 PCs used")
