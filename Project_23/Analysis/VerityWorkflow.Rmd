...
#Save the file
write.csv(astrocyte_treatment.markers, file = "Verity_astrocyte_prion.markers.csv")
...
cell_membership<-as.data.frame(Verity.combinedNBHME7$SingleR.labels.fine)

ggplot(cell_membership, aes(x = treatment, y = percent, fill = Cell_Type))+
