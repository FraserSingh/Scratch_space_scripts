...
```{r}
#work in progress https://satijalab.org/seurat/articles/integration_large_datasets.html
anchors <- FindIntegrationAnchors(object.list = Ximerakis.list.singlets, reference = c(1, 2), reduction = "rpca",
    dims = 1:50)
