...
```{r}
metadata_test<- metadata_test %>%
    filter(nUMI > 0, nGene >20, percent.mt <20)  # Filter out zero or negative values of nUMI, less than 20 genes (could raise to 50 but need biological justification), less than 20 % mito.
...
```{r}
#FIMXE Plot violins of the whole dataset without grouping for clarity
Idents.....
