...
ggp7<-cnetplot(SHp_GO_GSEA, colorEdge = TRUE,foldChange=geneList_SHp, showCategory=5)
...
png(paste0(plotting_path,"SHp_GO_GSEA_dotplot.png"), width = 1000,height = 750)
ggp6
dev.off()
png(paste0(plotting_path,"SHp_GO_GSEA_cnetplot.png"), width = 2000,height = 2000)
ggp7
dev.off()
png(paste0(plotting_path,"SHp_GO_GSEA_interactions.png"), width = 1500,height = 1500)
ggp7_1
dev.off()
