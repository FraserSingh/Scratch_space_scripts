...
p18<-VlnPlot(Slota_HP_comp, features = "nFeature_RNA", group.by = 'doublet_finder', pt.size = 0.0)#+ggtitle(paste0("Verity data", comp_pair))

p19<-VlnPlot(Slota_CX_comp, features = "nFeature_RNA", group.by = 'doublet_finder', pt.size = 0.0)#+ggtitle(paste0("Verity data", comp_pair))


png("Verity_HP_doublets.png", width = 2000,height = 1500)
p18
dev.off()

png("Verity_CX_doublets.png", width = 2000,height = 1500)
p19
dev.off()
...
#FIXME titles
DimPlot(Slota_HP_comp , reduction = "umap", group.by = "treatment", raster=FALSE)+ ggtitle("Verity Hippocampal cells labelled by treatment")

#cyclechange resolution number in group.by to see difference in clusters
DimPlot(Slota_HP_comp, group.by = 'RNA_snn_res.0.3', reduction = 'umap', label = TRUE, repel = TRUE, raster=F)+ggtitle("Verity Hippocampal cells labelled by cluster numbers")
...
# Upregulated genes
Slota_astrocyte_prion_markers_clean_HP_up<-subset(Slota_astrocyte_prion_markers_clean_HP, subset=avg_log2FC>(0.25)&p_val_adj<0.05) #Added p value filter here

#Create a list of just the genes:
Slota_HP_DEGs_up = (Slota_astrocyte_prion_markers_clean_HP_up$gene)
#Convert this gene SYMBOL list into Entrez ID:
Slota_DEGs_HPup__entrez = bitr(Slota_HP_DEGs_up, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db)
#Remove NAs
Slota_DEGs_HPup__entrez <-na.omit(Slota_DEGs_HPup__entrez)

#GO over-representation
Slota_HPup_GO_OvR = enrichGO(gene = Slota_DEGs_HPup__entrez$ENTREZID, OrgDb = org.Mm.eg.db, readable = T, ont= "BP", pvalueCutoff = 0.05, qvalueCutoff = 0.10)

#make background list
## feature 1: numeric vector
geneList = Slota_astrocyte_prion_markers_clean_HP$avg_log2FC

## feature 2: named vector of enembl IDs
names(geneList) = as.character(
  (bitr(Slota_astrocyte_prion_markers_clean_HP$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db))$ENTREZID
)

## feature 3: decreasing orde
geneList = sort(geneList, decreasing = TRUE)

ggp = barplot(Slota_HPup_GO_OvR , showCategory=20)
ggp2 = dotplot(Slota_HPup_GO_OvR, showCategory=20)
ggp3 = goplot(Slota_HPup_GO_OvR, showCategory = 20)
ggp4 = cnetplot(Slota_HPup_GO_OvR, categorySize=p.adjust)
ggp5<- cnetplot(Slota_HPup_GO_OvR, categorySize="pvalue")#, foldChange=geneList)
ggp6<-heatplot(Slota_HPup_GO_OvR, showCategory=20)#, foldChange=geneList)
...
png(paste0(plotting_path,"Terminal_Hp_GOR_barplot.png"), width = 1000,height = 750)
ggp
dev.off()
png(paste0(plotting_path,"Terminal_Hp_GOR_dotplot.png"), width = 1000,height = 750)
ggp2
dev.off()
png(paste0(plotting_path,"Terminal_Hp_GOR_goplot.png"), width = 1000,height = 750)
ggp3
dev.off()
png(paste0(plotting_path,"Terminal_Hp_GOR_cnetplot.png"), width = 1000,height = 750)
ggp4
dev.off()
png(paste0(plotting_path,"Terminal_Hp_GOR_cnetplot2.png"), width = 1000,height = 750)
ggp5
dev.off()
png(paste0(plotting_path,"Terminal_Hp_GOR_heatplot.png"), width = 3000,height = 750)
ggp6
dev.off()
...
# ego3 <- gseGO(geneList     = geneList, #full list of DEGs
#               OrgDb        = org.Mm.eg.db,
#               ont          = "ALL",
#               minGSSize    = 100,
#               maxGSSize    = 500,
...
#FIXME titles
DimPlot(Slota_CX_comp , reduction = "umap", group.by = "treatment", raster=FALSE)+ ggtitle("Verity Hippocampal cells labelled by treatment")

#cyclechange resolution number in group.by to see difference in clusters
DimPlot(Slota_CX_comp, group.by = 'RNA_snn_res.0.3', reduction = 'umap', label = TRUE, repel = TRUE, raster=F)+ggtitle("Verity Hippocampal cells labelled by cluster numbers")
...
# Upregulated genes
Slota_astrocyte_prion_markers_clean_CX_up<-subset(Slota_astrocyte_prion_markers_clean_CX,subset=avg_log2FC>(0.25)&p_val_adj<(0.05)) #Added p value filter here

#Create a list of just the genes: 
Slota_CX_DEGs_up = (Slota_astrocyte_prion_markers_clean_CX_up$gene)
#Convert this gene SYMBOL list into Entrez ID:
Slota_DEGs_CXup__entrez = bitr(Slota_CX_DEGs_up, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db)
#Remove NAs
Slota_DEGs_CXup__entrez <-na.omit(Slota_DEGs_CXup__entrez)

#GO over-representation
Slota_CXup_GO_OvR = enrichGO(gene = Slota_DEGs_CXup__entrez$ENTREZID, OrgDb = org.Mm.eg.db, readable = T, ont= "BP", pvalueCutoff = 0.05, qvalueCutoff = 0.10)



## feature 1: numeric vector
geneList = Slota_astrocyte_prion_markers_clean_CX$avg_log2FC

## feature 2: named vector of enembl IDs
names(geneList) = as.character(
  (bitr(Slota_astrocyte_prion_markers_clean_CX$gene, fromType = "SYMBOL", toType = "ENTREZID", OrgDb = org.Mm.eg.db))$ENTREZID
)

## feature 3: decreasing orde
geneList = sort(geneList, decreasing = TRUE)

ggp7 = barplot(Slota_CXup_GO_OvR , showCategory=20)
ggp8 = dotplot(Slota_CXup_GO_OvR, showCategory=20)
ggp9 = goplot(Slota_CXup_GO_OvR, showCategory = 20)
ggp10 = cnetplot(Slota_CXup_GO_OvR, categorySize=p.adjust)
ggp11<- cnetplot(Slota_CXup_GO_OvR, categorySize="pvalue")#, foldChange=geneList)
ggp12<-heatplot(Slota_CXup_GO_OvR, showCategory=20,)# foldChange=geneList)
...
png(paste0(plotting_path,"Terminal_Cx_GOR_barplot.png"), width = 1000,height = 750)
ggp7
dev.off()
png(paste0(plotting_path,"Terminal_Cx_GOR_dotplot.png"), width = 1000,height = 750)
ggp8
dev.off()
png(paste0(plotting_path,"Terminal_Cx_GOR_goplot.png"), width = 1000,height = 750)
ggp9
dev.off()
png(paste0(plotting_path,"Terminal_Cx_GOR_cnetplot.png"), width = 1000,height = 750)
ggp10
dev.off()
png(paste0(plotting_path,"Terminal_Cx_GOR_cnetplot2.png"), width = 1000,height = 750)
ggp11
dev.off()
png(paste0(plotting_path,"Terminal_Cx_GOR_heaplot.png"), width = 3000,height = 750)
ggp12
dev.off()
