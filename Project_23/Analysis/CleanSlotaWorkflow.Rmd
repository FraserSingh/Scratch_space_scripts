...
```{r}
#Specify the plotting folder to be made in the current working directory
...
p1
dev.off()
png(paste0(plotting_path,"Terminal_UMI_MT.png"), width = 1500,height = 1500)
p2
dev.off()
png(paste0(plotting_path,"Terminal_UMI_RP.png"), width = 3000,height = 1000)
p3
dev.off()
png(paste0(plotting_path,"Terminal_EDA.png"), width = 3000,height = 1000)
p4
...
metadata_filtered<- metadata_test %>%
    filter(nGene > 1000 & percent.mt < 20 & percent.rp > 1 & percent.hb < 20, nUMI < 350000) #FIXME check upper limit on nUMI
```
