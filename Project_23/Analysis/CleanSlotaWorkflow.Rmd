...
save(Slota_tissues, file="Rdata/Slota_tissues.RData")
...
#Save the object
save(Slota_HP_comp,file="Rdata/Slota_HP_comp.Rdata")
...
#save for reloading
save(Slota_HP_comp_astrocytes, file="Rdata/Slota_HP_comp_astrocytes.Rdata")
...
ggp2 = dotplot(Slota_HPup_GO_OvR, showCategory=10)
ggp3 = goplot(Slota_HPup_GO_OvR, showCategory = 10)
...
ggp6<-heatplot(Slota_HPup_GO_OvR, foldChange=geneList, showCategory=20)
...
#Save the object
save(Slota_CX_comp,file="Rdata/Slota_CX_comp.Rdata")
...
#save for reloading
save(Slota_CX_comp_astrocytes, file="Rdata/Slota_CX_comp_astrocytes.Rdata")
...
ggp8 = dotplot(Slota_CXup_GO_OvR, showCategory=10)
ggp9 = goplot(Slota_CXup_GO_OvR, showCategory = 10)
...
ggp12<-heatplot(Slota_CXup_GO_OvR, foldChange=geneList, showCategory=20)
