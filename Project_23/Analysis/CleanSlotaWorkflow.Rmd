...
sampleLabs<-(Slota_raw_obj_clean@active.ident)
...
sample_detect <- case_when(
  ...
  str_detect(sampleLabs, "RML134HP") ~ "RML134HP",
...
Idents(object=Slota_raw_obj_clean)<-Slota_raw_obj_clean$sample
...
Slota_list_clean <- SplitObject(Slota_filtered_clean, split.by = "orig.ident")
