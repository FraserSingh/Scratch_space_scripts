...
```
Treatment overlaps alot, so intergation is not required. The astrocyte markers show that clusters 6, 14, 20 and 24 expressed the astrocyte markers the strongest in our clusters or most definitively anyway
