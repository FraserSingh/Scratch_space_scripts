...
dir_name_Slota <- "Terminal_publication_level"

# create folder:
system(paste0("mkdir ", dir_name_Slota))

#save folder path for plot saving
plotting_path_Terminal<-paste0("../Analysis/", dir_name_Slota,"/")
...
# sample_names_Slota_file="/home/s2268606/University_Directories/Project_23/External_datasets/Slota_paper/Slota_samples.txt"
# 
...
sample_names_Slota<- readLines("/home/s2268606/University_Directories/Project_23/External_datasets/Slota_paper/Slota_samples.txt")
...
ggsave("Ximerakis_Cell_counts_per_sample_final.png",plot=Xim_filtered_final_cellpersammple,device='png', path=Xim_plotting_path_Terminal,width = 20, height = 15, units = 'cm' )
```
...
```{r}
p1_Terminal<-VlnPlot(Slota_raw_obj_clean, features=c("nFeature_RNA","nCount_RNA","percent.mt", "percent.rp","percent.hb"), ncol=5, pt.size = 0.0)+
    plot_annotation(title = "Slota EDA")+
    guides(fill = 'none')&
    scale_fill_manual(values = colour_df_Slota$colours)&
    theme(axis.text.x = element_text(size=rel(0.75),angle=90, hjust=1))
p1_Terminal
ggsave("Terminal_EDA.png",plot=p1_Terminal,device='png', path=plotting_path_Terminal,width = 40, height = 15, units = 'cm' )
...
#Save plots
png(paste0(plotting_path_Terminal,"Terminal_EDA.png"), width = 3000,height = 1000)
p1
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_UMI_MT.png"), width = 1750,height = 1500)
p2
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_UMI_RP.png"),width = 1750,height = 1500)
p3
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_RP_MT.png"),  width = 1750,height = 1500)
p4
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_UMI_nGene.png"), width = 1750,height = 1500)
p5
dev.off()
...
#Save plots
png(paste0(plotting_path_Terminal,"Terminal_PreF_Counts_sample.png"), width = 2000,height = 1500)
p6
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PreF_UMI_cell.png"),width = 2000,height = 1500)
p7
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PreF_nGene_hist_sample.png"),width = 2000,height = 1500)
p8
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PreF_nGene_hist_sample.png"),width = 2000,height = 1500)
p9
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PreF_nGene_UMI_sample.png"),width = 2000,height = 1500)
p10
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PreF_MT_cell.png"),width = 2000,height = 1500)
p11
dev.off()
```
...
#Save plots
png(paste0(plotting_path_Terminal,"Terminal_PostF_Counts_sample.png"), width = 2000,height = 1500)
p12
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PostF_UMI_cell.png"),width = 2000,height = 1500)
p13
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PostF_nGene_hist_sample.png"),width = 2000,height = 1500)
p14
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PostF_nGene_hist_sample.png"),width = 2000,height = 1500)
p15
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PostF_nGene_UMI_sample.png"),width = 2000,height = 1500)
p16
dev.off()
png(paste0(plotting_path_Terminal,"Terminal_PostF_MT_cell.png"),width = 2000,height = 1500)
p17
dev.off()
```
...
```{r}
load("../Analysis/Rdata/Slota_filtered_clean.RData")

Idents(Slota_filtered_clean)<-Slota_filtered_clean$sample

Slota_filtered_QC<-VlnPlot(Slota_filtered_clean, features=c("nFeature_RNA","nCount_RNA","percent.mt", "percent.rp","percent.hb"), ncol=5, pt.size = 0.0)&scale_fill_manual(values = colour_df_Slota$colours)&plot_annotation(title = "Slota dataset after all filtering")

Slota_filtered_QC
  
Slota_filtered_barplot<-Slota_filtered_clean@meta.data%>%
...
Slota_filtered_barplot

Slota_filtered_QC<-Slota_filtered_QC+
  Slota_filtered_barplot+
...
ggsave("Slota_filtered_QC.png",plot=Slota_filtered_QC,device='png', path="../Analysis/Terminal_publication_level/",width = 30, height = 15, units = 'cm' )
...
save(Slota_tissues, file=paste0(plotting_path_Terminal,"Slota_tissues.RData"))
...
#Save the object
save(Slota_HP_comp,file=paste0(plotting_path_Terminal,"Slota_HP_comp.Rdata"))
...
Slota_HP_astrocyte_markers_plot<-FeaturePlot(Slota_HP_comp,features=astrocyte_genes, raster=F,order=T)&plot_annotation(title = "Slota hippocampal data, labelled with astrocyte gene markers from ABCAM", subtitle="Clustering resolution 0.3, 20 PCs used")&scale_colour_gradient(low = "lightgrey", high = "blue",limits = c(0, 8))
...
Slota_HP_astrocyte_markers_plot<- plot_without_legend + plot_layout(guides = "collect",ncol=3) 

ggsave("Slota_HP_astrocyte_markers.png",plot=Slota_HP_astrocyte_markers_plot,device='png', path=plotting_path_Terminal,width = 30, height = 20, units = 'cm' )
...
#save for reloading
save(Slota_HP_comp_astrocytes, file=paste0(plotting_path_Terminal,"Slota_HP_comp_astrocytes.Rdata"))

#cyclechange resolution number in group.by to see difference in clusters
Slota_HP_astrocyte_treatment_plot<-DimPlot(Slota_HP_comp_astrocytes, reduction = 'umap',  raster=F, group.by='treatment')+ggtitle("Slota data's Hippocampal astrocytes", subtitle="Labelled by treatment")

ggsave("Slota_HP_astrocyte_treatment_plot.png",plot=Slota_HP_astrocyte_treatment_plot,device='png', path=plotting_path_Terminal,width = 20, height = 15, units = 'cm' )
...
Slota_HP_reactive_astrocyte_plot<-FeaturePlot(Slota_HP_comp_astrocytes,features=c('Gfap','Cd44'), raster=F)&plot_annotation(title = "Slota data's Hippocampal astrocytes", subtitle="Highlighting expression of reactive astrocyte genes")
Slota_HP_reactive_astrocyte_plot
ggsave("Slota_HP_reactive_astrocyte_plot.png",plot=Slota_HP_reactive_astrocyte_plot,device='png', path=plotting_path_Terminal,width = 30, height = 10, units = 'cm' )
...
#Save the file
write.csv(Slota_astrocyte_prion_markers_clean_HP, file = paste0(plotting_path_Terminal,"Slota_astrocyte_prion_markers_clean_HP.csv"))

save(Slota_astrocyte_prion_markers_clean_HP, file=paste0(plotting_path_Terminal,"Slota_astrocyte_prion_markers_clean_HP.RData"))
...
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_barplot.png"), width = 1000,height = 750)
ggp
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_dotplot.png"), width = 1000,height = 750)
ggp2
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_goplot.png"), width = 1000,height = 750)
ggp3
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_cnetplot.png"), width = 1000,height = 750)
ggp4
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_heatplot.png"), width = 3000,height = 1000)
ggp5
dev.off()
```
...
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_down_barplot.png"), width = 1000,height = 750)
ggp_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_down_dotplot.png"), width = 1000,height = 750)
ggp2_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_down_goplot.png"), width = 1000,height = 750)
ggp3_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_down_cnetplot.png"), width = 1500,height = 1000)
ggp4_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GOR_down_heatplot.png"), width = 3600,height = 750)
ggp5_b
dev.off()
```
...
png(paste0(plotting_path_Terminal_term,"SHp_GO_GSEA_dotplot.png"), width = 1000,height = 750)
ggp6
dev.off()
png(paste0(plotting_path_Terminal_term,"SHp_GO_GSEA_cnetplot.png"), width = 2000,height = 2000)
ggp7
dev.off()
png(paste0(plotting_path_Terminal_term,"SHp_GO_GSEA_interactions.png"), width = 1500,height = 1500)
ggp7_1
dev.off()
png(paste0(plotting_path_Terminal_term,"SHp_GO_GSEA_synapse_snet.png"), width = 3000,height = 1000)
ggp7_2_Hp
dev.off()
...
png(paste0(plotting_path_Terminal,"Slota_Prion_GSEA_heatplot_Reactome.png"), width = 3000,height = 1000)
ggp8
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GSEA_cnetplot_circular_Reactome.png"), width =2000,height = 2000)
ggp9
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GSEA_cnetplot_Reactome.png"), width =2000,height = 2000)
ggp10
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GSEA_ridgeplot_Reactome.png"), width = 1000,height = 750)
ggp11
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Prion_GSEA_interactions_plot_Reactome.png"), width = 1500,height = 1500)
ggp12
dev.off()
```
...
#Save the object
save(Slota_CX_comp,file=paste0(plotting_path_Terminal,"Slota_CX_comp.Rdata"))
...
Slota_CX_astrocyte_markers_plot<-FeaturePlot(Slota_CX_comp,features=astrocyte_genes, raster=F,order=T)&plot_annotation(title = "Slota cortical data, labelled with astrocyte gene markers from ABCAM", subtitle="Clustering resolution 0.3, 20 PCs used")&scale_colour_gradient(low = "lightgrey", high = "blue",limits = c(0, 8))
...
# Combine the plot and legend using patchwork
Slota_CX_astrocyte_markers_plot<- plot_without_legend + plot_layout(guides = "collect",ncol=3) 

ggsave("Slota_CX_astrocyte_markers.png",plot=Slota_CX_astrocyte_markers_plot,device='png', path=plotting_path_Terminal,width = 30, height = 20, units = 'cm' )
...
#save for reloading
save(Slota_CX_comp_astrocytes, file=paste0(plotting_path_Terminal,"Slota_CX_comp_astrocytes.Rdata"))

Slota_CX_astrocyte_treatment_plot<-DimPlot(Slota_CX_comp_astrocytes, reduction = 'umap',  raster=F, group.by='treatment')+ggtitle("Slota data's cortical astrocytes", subtitle="Labelled by treatment")
Slota_CX_astrocyte_treatment_plot
ggsave("Slota_CX_astrocyte_treatment_plot.png",plot=Slota_CX_astrocyte_treatment_plot,device='png', path=plotting_path_Terminal,width = 20, height = 15, units = 'cm' )
...
#Show astrocyte markers in astrocyte subset
Slota_CX_reactive_astrocyte_plot<-FeaturePlot(Slota_CX_comp_astrocytes,features=c('Gfap','Cd44'), raster=F)&plot_annotation(title = "Slota data's cortical astrocytes", subtitle="Highlighting expression of reactive astrocyte genes")
Slota_CX_reactive_astrocyte_plot
ggsave("Slota_CX_reactive_astrocyte_plot.png",plot=Slota_CX_reactive_astrocyte_plot,device='png', path=plotting_path_Terminal,width = 30, height = 10, units = 'cm' )
...
save(Slota_astrocyte_prion_markers_clean_CX, file=paste0(plotting_path_Terminal,"Slota_astrocyte_prion_markers_clean_CX.RData"))
...
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_barplot.png"), width = 1000,height = 750)
ggp
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_dotplot.png"), width = 1000,height = 750)
ggp2
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_goplot.png"), width = 1000,height = 750)
ggp3
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_cnetplot.png"), width = 1000,height = 750)
ggp4
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_heatplot.png"), width = 3000,height = 1000)
ggp5
dev.off()
```
...
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_down_barplot.png"), width = 1000,height = 750)
ggp_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_down_dotplot.png"), width = 1000,height = 750)
ggp2_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_down_goplot.png"), width = 1000,height = 750)
ggp3_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_down_cnetplot.png"), width = 1500,height = 1000)
ggp4_b
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GOR_down_heatplot.png"), width = 3600,height = 750)
ggp5_b
dev.off()
```
...
png(paste0(plotting_path_Terminal,"SCx_GO_GSEA_dotplot.png"), width = 1000,height = 750)
ggp6
dev.off()
png(paste0(plotting_path_Terminal,"SCx_GO_GSEA_cnetplot.png"), width = 2000,height = 2000)
ggp7
dev.off()
png(paste0(plotting_path_Terminal,"SCx_GO_GSEA_interactions.png"), width = 1500,height = 1500)
ggp7_1
dev.off()
png(paste0(plotting_path_Terminal_term,"SCx_GO_GSEA_synapse_cnet.png"), width = 3000,height = 1000)
ggp7_2
dev.off()
...
png(paste0(plotting_path_Terminal,"Slota_Cx_GSEA_heatplot_Reactome.png"), width = 3000,height = 1000)
ggp8
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GSEA_cnetplot_circular_Reactome.png"), width =2000,height = 2000)
ggp9
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GSEA_cnetplot_Reactome.png"), width =2000,height = 2000)
ggp10
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GSEA_ridgeplot_Reactome.png"), width = 1000,height = 750)
ggp11
dev.off()
png(paste0(plotting_path_Terminal,"Slota_Cx_GSEA_interactions_plot_Reactome.png"), width = 1500,height = 1500)
ggp12
dev.off()
