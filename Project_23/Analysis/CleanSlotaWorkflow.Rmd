...
Slota_HP_astrocyte_markers_plot<-FeaturePlot(Slota_HP_comp,features=astrocyte_genes, raster=F,order=T, label = T)&plot_annotation(title = "Slota hippocampal data, labelled with astrocyte gene markers from ABCAM", subtitle="Clustering resolution 0.3, 20 PCs used")&scale_colour_gradient(low = "lightgrey", high = "blue",limits = c(0, 8))
...
# Combine the plot and legend using patchwork
Slota_HP_reactive_astrocyte_plot<- plot_without_legend + plot_layout(guides = "collect",ncol=3) 

Slota_HP_reactive_astrocyte_plot
ggsave("Slota_HP_reactive_astrocyte_plot.png",plot=Slota_HP_reactive_astrocyte_plot,device='png', path=plotting_path_Terminal,width = 20, height = 20, units = 'cm' )
...
save(Slota_astrocyte_prion_markers_clean_HP, file=paste0("../Analysis/Rdata/Slota_astrocyte_prion_markers_clean_HP.RData"))
```
...
#save the data
save(Slota_astrocyte_HP_markers_entrez, file=paste0("../Analysis/Rdata/Slota_astrocyte_HP_markers_entrez.RData"))
```
...
# Combine the plot and legend using patchwork
Slota_CX_reactive_astrocyte_plot<- plot_without_legend + plot_layout(guides = "collect",ncol=3) 

Slota_CX_reactive_astrocyte_plot
ggsave("Slota_CX_reactive_astrocyte_plot.png",plot=Slota_CX_reactive_astrocyte_plot,device='png', path=plotting_path_Terminal,width = 25, height = 20, units = 'cm' )
...
save(Slota_astrocyte_prion_markers_clean_CX_entrez, file=paste0(writing_dir,"Slota_astrocyte_prion_markers_clean_CX_entrez.RData"))
```
